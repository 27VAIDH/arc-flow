...
export default function PomodoroTimer() {
  ...
  return (
    <div className="mx-4 mb-1 flex items-center gap-2 px-3 py-1.5 text-xs rounded-lg bg-arc-accent/10 dark:bg-arc-accent/5 text-gray-700 dark:text-arc-text-primary animate-fade-in">
      {/* Timer display */}
